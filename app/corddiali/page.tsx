...
export default function Empresa() {
 ...
 style={{
  backgroundImage: "url('/images/fundo-marmore-corddiali.jpeg')",
        ...
        <div className="container-x">
          ...
          <div className="max-w-5xl">
            ...
            <div className="mt-8 max-w-4xl">
              <p className="muted text-lg leading-8">
                A Corddiali é uma construtora especializada na construção de
                residências de alto padrão, para clientes que buscam transformar
                seus projetos em casas que traduzam seu estilo, patrimônio e
                forma de viver.
              </p>

              <p className="muted mt-7 text-lg leading-8">
                Atuamos principalmente em empreendimentos e bairros planejados
                de alto padrão, como Viva Park e All Wert Resort, conduzindo
                cada projeto com planejamento, gestão e execução personalizada.
              </p>

              <p className="muted mt-7 text-lg leading-8">
                Nosso trabalho começa muito antes da primeira etapa da obra.
                A partir do projeto arquitetônico, estruturamos toda a execução:
                planejamento, compras, fornecedores, cronograma,
                compatibilização, acompanhamento e controle de cada etapa.
              </p>

              <p className="muted mt-7 text-lg leading-8">
                Tudo isso dentro do nosso método Turnkey (chaves na mão), com
                preço fechado.
              </p>

              <p className="muted mt-7 text-lg leading-8">
                Na prática, significa ter uma única equipe responsável por
                conduzir a construção do início à entrega, reduzindo a
                complexidade para o cliente e trazendo mais previsibilidade para
                um investimento de alto valor.
              </p>

              <p className="muted mt-7 text-lg leading-8">
                Hoje, nossa experiência reúne obras entregues e projetos
                residenciais em andamento, consolidando a Corddiali em um
                mercado onde qualidade construtiva precisa caminhar junto com
                gestão, confiança e atenção aos detalhes.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-center mt-24">
            ...
            <div className="md:pr-6 order-2 md:order-1">
              ...
              <p className="muted mt-6 leading-8">
                Com 28 anos e residente em Itapema há mais de duas décadas,
                Luisa Corrêa tem sua trajetória fortemente ligada ao mercado
                imobiliário e da construção civil, setor no qual sua família
                atua desde 1998. Empreendedora por natureza, é sócia e
